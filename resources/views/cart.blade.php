                    ...
                    <div class="table-responsive checkout-content default">
                        <table class="table">
                            ...
                            @foreach($products as $product)
                                @php
                                    $productAdded = \Illuminate\Support\Facades\DB::table('products')->where('id',$product->product_id)->first();
                                    ...
                                    <tr class="checkout-item">
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('cart.destroy',$product->id) }}" method="post">
                                                @CSRF
                                                @method('delete')
                                                <button class="checkout-btn-remove" type="submit"></button>
                                            </form>
                                        </td>
                                        <td>
                                        ...
                                        <td>{{ $product->quantity==null || $product->quantity== 1 ? number_format($productAdded->price) : number_format($product->quantity * $productAdded->price) }} تومان</td>
                                    </tr>
                                @endif
                            @endforeach
                            </tbody>
